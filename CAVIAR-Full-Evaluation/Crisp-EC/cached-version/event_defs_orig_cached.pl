/****************************************************************************
 * Crisp-EC caching-adapted event definitions for Public Space Surveillance *
 ****************************************************************************/

:- multifile holdsAt/2, happensAt/2.
:- discontiguous holdsAt/2, happensAt/2, initiatedAt/2.

:- ensure_loaded(library(lists)).

% Load Crisp-EC domain-independent engine:
 ...
 * leaving_object(Person1, Person2)				  *		  			  *								  *
 *								  *
